...
class ArankClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyArank.functions.FastTelethon import upload_file
        from pyArank.functions.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pyArank.functions.FastTelethon import download_file
        from pyArank.functions.helper import progress
