...
def load_addons(plugin_name):
    ...
    mod.asst = asst
    mod.tgbot = asst
    mod.Arank_bot = Arank_bot
    mod.ub = Arank_bot
    mod.bot = Arank_bot
    mod.Arank = Arank_bot
    mod.borg = Arank_bot
    mod.telebot = Arank_bot
    mod.jarvis = Arank_bot
    mod.friday = Arank_bot
    mod.eod = eod
    mod.edit_delete = eod
    mod.LOGS = LOGS
    ...
    mod.Arank_cmd = Arank_cmd
    mod.on_cmd = Arank_cmd
