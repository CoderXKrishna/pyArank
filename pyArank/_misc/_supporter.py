...
from pyArank._misc._decorators import compile_pattern, Arank_cmd
...
ALIVE_NAME = Arank_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = Arank_bot
catub.cat_cmd = Arank_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Arank")
