...
with open("pyArank/version.py", "rt", encoding="utf8") as x:
...
author_email = "CoderXKrishna@protonmail.ch"
description = "A Secure and Powerful Python-Telethon Based Library For Arank Userbot."
